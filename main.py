...
if __name__ == '__main__':  # Execute the following code only when executing main.py (not when importing it)
    ...
    # Input Your Binance API Key here
    binance = BinanceClient("your-API-Key",
                            "your-API-Secret",
                            testnet=True, futures=True)
    # Input Your bitmax API Key here
    bitmex = BitmexClient("your-API-Key", "your-API-Secre", testnet=True)
